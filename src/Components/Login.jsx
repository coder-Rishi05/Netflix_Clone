        ...
        >
          <div className=" z-1 py-6 flex relative flex-col">
            ...
            <button
              ...
              className="py-2 px-4 rounded my-2 cursor-pointer hover:bg-red-700  mx-[4rem] bg-red-600 text-white font-bold"
            >
              {isSignIN ? "Sign In" : "Sign Up"}
            </button>
            ...
            <a className="text-center text-white underline my-3 hover:text-zinc-400 ">
              Forgot password
            </a>
